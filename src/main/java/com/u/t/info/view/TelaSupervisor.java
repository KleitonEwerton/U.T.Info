...
public class TelaSupervisor extends JFrame {
    ...
    public void desenhaPainelEstoque() {
        ...
        this.estoque.setBorder(BorderFactory.createTitledBorder("Estoque"));
        ...
        this.tabelaProdutos = new JTable(modelProduto);
        this.tabelaProdutos.setVisible(true);

        //this.tabelaProdutos.setPreferredScrollableViewportSize(new Dimension(800, 400));

        barraRolagem = new JScrollPane(tabelaProdutos);
        this.estoque.add(barraRolagem, BorderLayout.CENTER);

        //oq fazer????
        JButton notificarGerente = new JButton("Notificar gerente");
        this.estoque.add(notificarGerente);

        this.painelPrincipal.add(this.estoque, BorderLayout.EAST);
    }
